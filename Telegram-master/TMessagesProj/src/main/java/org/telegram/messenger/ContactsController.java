...
public class ContactsController {
    //Hossein
    public String Invite_text = ApplicationLoader.mContext.getResources().getString(R.string.vadainvitetext);
    public static boolean showFavoriteContact;
    public static boolean showOnlineContact;
    //---------------
                        ...
                        Utilities.stageQueue.postRunnable(new Runnable() {
                            ...
                            public void run() {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        if (!showFavoriteContact && !showOnlineContact) //Hossein
                    ...
                    public void run() {
                        ...
                        for (int a = 0; a < contactsArr.size(); a++) {
                            ...
                            if (showFavoriteContact) {
                                if (!ApplicationLoader.specificContacts.contains(String.valueOf(user.id)))
                                    continue;
                            }
                            if (showOnlineContact) {
