...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace));
        ...
        doneTextView.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace));
        ...
        tintShadowsButton.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace));
        ...
        tintHighlightsButton.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace));
