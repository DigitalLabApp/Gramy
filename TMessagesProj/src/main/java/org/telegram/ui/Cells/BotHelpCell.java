...
public class BotHelpCell extends View {
    ...
    public void setText(String text) {
        ...
        stringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace)), 0, help.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);    //Hossein
