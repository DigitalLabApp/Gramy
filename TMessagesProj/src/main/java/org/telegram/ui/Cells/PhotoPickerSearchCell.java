...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    private class SearchButton extends FrameLayout {
        ...
        public SearchButton(Context context) {
            ...
            textView1.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace)); //Hossein
            ...
            textView2.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationTypeFace)); //Hossein
