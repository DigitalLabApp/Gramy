...
public class DrawerProfileCell extends FrameLayout {
    ...
    private class CloudView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            if (ApplicationLoader.isCustomTheme() && ApplicationLoader.getCachedWallpaper() != null) {
                ...
                paint.setColor(Color.parseColor(ApplicationLoader.applicationTheme));
            }
    ...
    public void setUser(TLRPC.User user) {
        ...
        if (Database.getInstance().readSetting("5", ApplicationLoader.mContext).equals("1"))
            phoneTextView.setVisibility(View.INVISIBLE);
        else phoneTextView.setVisibility(View.VISIBLE);
        //---------------
        AvatarDrawable avatarDrawable = new AvatarDrawable(user);
        avatarDrawable.setColor(Theme.ACTION_BAR_MAIN_AVATAR_COLOR);
        avatarImageView.setImage(photo, "50_50", avatarDrawable);
        setBackgroundColor(Color.parseColor(ApplicationLoader.applicationTheme)); //Hossein
