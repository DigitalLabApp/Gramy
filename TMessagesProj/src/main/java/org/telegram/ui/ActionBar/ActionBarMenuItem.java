...
public class ActionBarMenuItem extends FrameLayout {
    ...
    //Hossein
    public void updateSubItem(int id, String text, int icon) {
        ((TextView) popupLayout.findViewWithTag(id)).setText(text);
    }
//------------------------------
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            searchField.setHintTextColor(Color.GRAY);//Hossein
            searchField.setTextColor(Color.BLACK);//Hossein
            ...
            //Hossein
            clearButton.setColorFilter(Color.GRAY, PorterDuff.Mode.SRC_IN);
            //--------------------------------------------
            ...
            clearButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    //Hossein
                    if (searchField != null && searchField.getText() != null && searchField.getText().toString().length() == 0 && onCancleListener != null) {
